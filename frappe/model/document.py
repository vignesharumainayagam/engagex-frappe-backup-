...
class Document(BaseDocument):
	...
	def insertapi(self, status, ignore_permissions=None, ignore_if_duplicate=False, ignore_mandatory=None):
	...
	def _save(self, ignore_permissions=True, ignore_version=None):
